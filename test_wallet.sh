...
dfx canister call piwallet_backend get_balance
echo "Expected: Initial balance should be 1000000 for deployer"

# Test 2: Test minting
echo -e "\n${GREEN}Test 2: Testing mint function${NC}"
dfx canister call piwallet_backend mint "(principal \"$TEST_PRINCIPAL\", 500)"
...
dfx canister call piwallet_backend send_tokens "(principal \"$IDENTITY_PRINCIPAL\", 200)"
...
dfx identity use test_user
dfx canister call piwallet_backend send_tokens "(principal \"$IDENTITY_PRINCIPAL\", 1000000)"
...
dfx canister call piwallet_backend address_exists "(principal \"$TEST_PRINCIPAL\")"
echo "Expected: Should return true"

# Test 9: Get total supply
echo -e "\n${GREEN}Test 9: Testing get_total_supply${NC}"
dfx canister call piwallet_backend get_total_supply
